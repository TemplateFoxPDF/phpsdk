...
/**
 * PdfInput Class Doc Comment
 *
 * @category Class
 * @description Either pdf_url (HTTPS) or pdf_base64 — exactly one.
 * @package  TemplateFox
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PdfInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PdfInput';
