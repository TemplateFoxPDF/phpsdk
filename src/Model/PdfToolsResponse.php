...
/**
 * PdfToolsResponse Class Doc Comment
 *
 * @category Class
 * @package  TemplateFox
 * @author   OpenAPI Generator team
 ...
 */
class PdfToolsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PdfToolsResponse';
     ...
     * Sets url
     *
     * @param string $url Signed URL to download the PDF
     *
     * @return self
     */
     ...
     * Sets filename
     *
     * @param string $filename Filename of the resulting PDF
     *
     * @return self
     */
