...
/**
 * ExtractPdfPagesRequest Class Doc Comment
 *
 * @category Class
 * @package  TemplateFox
 * @author   OpenAPI Generator team
 ...
 */
class ExtractPdfPagesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExtractPdfPagesRequest';
    ...
    public function setExpiration($expiration)
    {
        ...
        if (($expiration > 604800)) {
            throw new \InvalidArgumentException('invalid value for $expiration when calling ExtractPdfPagesRequest., must be smaller than or equal to 604800.');
        }
        if (($expiration < 60)) {
            throw new \InvalidArgumentException('invalid value for $expiration when calling ExtractPdfPagesRequest., must be bigger than or equal to 60.');
        }
    ...
    public function setFilename($filename)
    {
        ...
        if (!is_null($filename) && (mb_strlen($filename) > 100)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling ExtractPdfPagesRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($filename) && (!preg_match("/^[a-zA-Z0-9_\\-\\.]+$/", ObjectSerializer::toString($filename)))) {
            throw new \InvalidArgumentException("invalid value for \$filename when calling ExtractPdfPagesRequest., must conform to the pattern /^[a-zA-Z0-9_\\-\\.]+$/.");
        }
     ...
     * Sets pages
     *
     * @param string $pages 1-indexed page selection. Supports ranges and singles separated by commas, e.g. `1-3, 5, 7-9`. Order is preserved (`5,1,3` outputs those 3 pages in that order).
     *
     * @return self
     */
