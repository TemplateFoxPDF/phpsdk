...
/**
 * CreatePdfResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePdfResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePdfResponse';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url Signed URL to download the PDF (expires after specified time)
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int $expires_in Seconds until URL expires
     *
     * @return self
     */
