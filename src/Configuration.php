...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.templatefox.com';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.9.5/PHP';
    ...
    {
        $report  = 'PHP SDK (TemplateFox) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.9.5' . PHP_EOL;
