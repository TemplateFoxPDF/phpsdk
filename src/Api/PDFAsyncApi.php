...
class PDFAsyncApi
{
     ...
     * Get PDF job status
     *
     * @param  string $job_id Async job ID (UUID returned by the create-async endpoint) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPdfJob'] to see the possible values for this operation
     *
     * @throws \TemplateFox\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \TemplateFox\Model\JobStatusResponse|\TemplateFox\Model\HTTPValidationError
     */
    public function getPdfJob($job_id, string $contentType = self::contentTypes['getPdfJob'][0])
    {
        list($response) = $this->getPdfJobWithHttpInfo($job_id, $contentType);
        return $response;
    }

    /**
     * Operation getPdfJobWithHttpInfo
     *
     * Get PDF job status
     *
     * @param  string $job_id Async job ID (UUID returned by the create-async endpoint) (required)
     ...
     */
    public function getPdfJobWithHttpInfo($job_id, string $contentType = self::contentTypes['getPdfJob'][0])
    {
        $request = $this->getPdfJobRequest($job_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPdfJobAsync($job_id, string $contentType = self::contentTypes['getPdfJob'][0])
    {
        return $this->getPdfJobAsyncWithHttpInfo($job_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPdfJobAsyncWithHttpInfo
     *
     * Get PDF job status
     *
     * @param  string $job_id Async job ID (UUID returned by the create-async endpoint) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPdfJobAsyncWithHttpInfo($job_id, string $contentType = self::contentTypes['getPdfJob'][0])
    {
    ...
    /**
     * Create request for operation 'getPdfJob'
     *
     * @param  string $job_id Async job ID (UUID returned by the create-async endpoint) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPdfJob'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPdfJobRequest($job_id, string $contentType = self::contentTypes['getPdfJob'][0])
    {

        // verify the required parameter 'job_id' is set
        if ($job_id === null || (is_array($job_id) && count($job_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $job_id when calling getPdfJob'
            );
        }


        $resourcePath = '/v1/pdf/jobs/{job_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * List PDF jobs
     *
     * @param  int|null $limit Maximum number of results to return (optional, default to 20)
     * @param  int|null $offset Number of results to skip (for pagination) (optional, default to 0)
     * @param  \TemplateFoxModelAppRoutersV1PdfAsyncJobStatus|null $status Filter jobs by status (optional)
    ...
    public function listPdfJobsRequest($limit = 20, $offset = 0, $status = null, string $contentType = self::contentTypes['listPdfJobs'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'AppRoutersV1PdfAsyncJobStatus', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
